...
cl = LINETCR.LINE()
cl.login(token="EsRB4MuK76by1YxkKBGc.lLmk6/SZmKAMJdr6V+rlta.mo8qZmQbJ3oTs8mLXXQCxo4+SVX9+ThOuc2es4e3pCg=")
cl.loginResult()
...
Bots=[mid]
admin = ["u2e530aebeb333246a68c347abff44b4c"]
wait = {
    "likeOn":True,
    "alwayRead":False,
    "detectMention":True,    
...
#==============================================================================#
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': "u2e530aebeb333246a68c347abff44b4c"}
                cl.sendMessage(msg)
